...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2016 at 05:39 PM
...
(11, 'DS', 'Computer Science & Engineering'),
...
ALTER TABLE `batch_course`
  ADD PRIMARY KEY (`program_year`,`course_id`);
...
ALTER TABLE `student_test_marks`
  ADD PRIMARY KEY (`roll_no`,`test_id`);
